...
namespace CamRent_Infrastructure.Persistence
{
  ...
  //      public DbSet<DeviceCategoryLink> DeviceCategories => Set<DeviceCategoryLink>();
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
			...
			modelBuilder.Ignore<BookingItem>();
			modelBuilder.Ignore<Contract>();
			modelBuilder.Ignore<ContractSignature>();
			modelBuilder.Ignore<Payment>();
			modelBuilder.Ignore<PaymentLine>();
			modelBuilder.Ignore<PaymentEvent>();
			modelBuilder.Ignore<Dispute>();
			modelBuilder.Ignore<DisputeItem>();
			modelBuilder.Ignore<VerificationRequest>();
			modelBuilder.Ignore<VerificationRequestItem>();
			modelBuilder.Ignore<Inspection>();
			modelBuilder.Ignore<Wallet>();
			modelBuilder.Ignore<WalletTransaction>();
			modelBuilder.Ignore<HandoverReceipt>();
			modelBuilder.Ignore<DeliveryTask>();
